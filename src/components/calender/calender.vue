  ...
  <div class="calender">
    ...
    <div class="calender-content-wrapper">
      ...
      <div class="calender-content">
        ...
        >
          <div class="calender-item" :class="item.chetrue?'d':''">
    ...
    _getFirstDaysForMonth(year, month) {
      ...
      for (let i = 0; i < this.daysArr.length; i++) {
        ...
        for (let k = 0; k < this.markArr.length; k++) {
          var chetrue = this.markArr[k].days.includes(dateStr);
          if (chetrue) {
            this.daysArr[i].chetrue = chetrue;
          } else {
...
@font-face {
  font-family: "iconfont"; /* project id 777975 */
  src: url("//at.alicdn.com/t/font_777975_gq4z7m1xo8i.eot");
  src: url("//at.alicdn.com/t/font_777975_gq4z7m1xo8i.eot?#iefix")
      format("embedded-opentype"),
    url("//at.alicdn.com/t/font_777975_gq4z7m1xo8i.woff2") format("woff2"),
    url("//at.alicdn.com/t/font_777975_gq4z7m1xo8i.woff") format("woff"),
    url("//at.alicdn.com/t/font_777975_gq4z7m1xo8i.ttf") format("truetype"),
    url("//at.alicdn.com/t/font_777975_gq4z7m1xo8i.svg#iconfont") format("svg");
}
.iconfont {
